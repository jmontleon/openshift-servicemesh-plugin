...
export const globalStyle = kialiStyle({
  ...
  $nest: {
     ...
     */
    '& .pf-v5-c-tooltip a': {
      color: "var(--pf-t--temp--dev--tbd)"/* CODEMODS: original v5 color was --pf-v5-global--link--Color--light */,
      $nest: {
        '&:hover': {
          color: "var(--pf-t--temp--dev--tbd)"/* CODEMODS: original v5 color was --pf-v5-global--link--Color--light--hover */
        }
      }
    },
