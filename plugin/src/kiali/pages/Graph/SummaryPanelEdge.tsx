        ...
        <div className={panelHeadingStyle}>
          ...
          {hasPrincipals && (
            <>
              ...
              <Tooltip key="tt_src_ppl" position="top" content={`Source principal: ${edgeData.sourcePrincipal}`} appendTo="inline">
                <span className={principalStyle}>{edgeData.sourcePrincipal ?? 'unknown'}</span>
              </Tooltip>

              <Tooltip key="tt_src_ppl" position="top" content={`Destination principal: ${edgeData.destPrincipal}`} appendTo="inline">
          ...
          <div className={panelHeadingStyle}>
            ...
            {isBidirectional && (
              <div className={switchWaypointIcon}>
                <Tooltip key="waypoint" position="top" content="Switch From/To" appendTo="inline">
                  <a
                    href="#"
